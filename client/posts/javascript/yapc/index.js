...
const update =
  "**UPDATE May 25, 2020** Unfortunately I deleted the server hosting this project and haven't had time to fix it. I'll hopefully clear this up in the future. Seeing as I'm on linux again (not chromebooks) and there are similar tools, this project isn't much of a priority for me"
...
const Component = ({ _static }) => (
  <>
    ...
    <img
      src={_static('yapc-v0.1.png')}
      alt="Screenshot of first release of my program"
    />
